...
exports.BleLockProtocol = void 0;
...
class BleLockProtocol {
     ...
     */
    static isHeartbeat(frame) {
        return !frame.isEncrypted && frame.commandCode === types_1.SmartLockBleCommandFunctionType2.NOTIFY;
    }
    /**
     * Checks whether a parsed BLE frame is a lock/unlock command acknowledgment.
     */
    static isLockCommandResponse(frame) {
        return frame.isResponse && frame.commandCode === types_1.SmartLockBleCommandFunctionType2.ON_OFF_LOCK;
    }
    /**
...
exports.BleLockProtocol = BleLockProtocol;
//# sourceMappingURL=ble-lock-protocol.js.map