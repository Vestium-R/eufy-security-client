...
class Station extends tiny_typed_emitter_1.TypedEmitter {
    ...
    static async getInstance(api, stationData, ipAddress, listeningPort, enableEmbeddedPKCS1Support) {
        ...
        if (device_1.Device.isLock(stationData.device_type) &&
            ...
            !device_1.Device.isLockWifiT85D0(stationData.device_type)) {
    ...
    lockDevice(device, value) {
        ...
        if (device.isLockBleNoFinger() || device.isLockBle()) {
            ...
            logging_1.rootHTTPLogger.debug("Station lock device - Using security MQTT...", {
                station: this.getSerial(),
                device: device.getSerial(),
                value: value,
            });
            this.emit("security mqtt command", this, device.getSerial(), this.rawStation.member.admin_user_id, this.rawStation.member.short_user_id, this.rawStation.member.nick_name, device.getChannel(), this.p2pSession.incLockSequenceNumber(), value, propertyData);
        }
    ...
    getLockParameters() {
        ...
        if (device_1.Device.isLockWifiT8506(this.getDeviceType()) ||
            ...
            device_1.Device.isLockWifiT85D0(this.getDeviceType())) {
