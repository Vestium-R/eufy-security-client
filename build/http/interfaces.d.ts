...
export interface StationEvents {
    ...
    "security mqtt command": (station: Station, deviceSN: string, adminUserId: string, shortUserId: string, nickName: string, channel: number, sequence: number, lock: boolean, property: PropertyData) => void;
